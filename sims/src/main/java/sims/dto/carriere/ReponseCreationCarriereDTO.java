...
public class ReponseCreationCarriereDTO {
	...
	private List<ReponseCreationBrancheCarriereDTO> branches;

    // Constructeurs
    public ReponseCreationCarriereDTO() {
    }
    ...
    public List<ReponseCreationBrancheCarriereDTO> getBranches() {
        return branches;
    }

    public void setBranches(List<ReponseCreationBrancheCarriereDTO> branches) {
