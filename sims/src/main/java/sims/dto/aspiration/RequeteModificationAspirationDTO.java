...
public class RequeteModificationAspirationDTO {
	...
	private List<RequeteModificationEtapeAspirationDTO> etapes;

    // Constructeurs
    public RequeteModificationAspirationDTO() {
    }
    ...
    public List<RequeteModificationEtapeAspirationDTO> getEtapes() {
        return etapes;
    }

    public void setEtapes(List<RequeteModificationEtapeAspirationDTO> etapes) {
        this.etapes = etapes;
    }
}
