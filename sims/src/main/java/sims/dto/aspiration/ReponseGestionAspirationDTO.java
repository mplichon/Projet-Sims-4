...
public class ReponseGestionAspirationDTO {
	...
	private List<ReponseGestionEtapeAspirationDTO> etapes;

    // Constructeurs
    public ReponseGestionAspirationDTO() {
    }
    ...
    public List<ReponseGestionEtapeAspirationDTO> getEtapes() {
        return etapes;
    }

    public void setEtapes(List<ReponseGestionEtapeAspirationDTO> etapes) {
        this.etapes = etapes;
    }
}
